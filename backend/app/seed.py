...
def seed_synthetic_semester(session: Session) -> bool:
    ...
    # Timetable transcribed from the supplied AIML-A Semester 5 timetable.
    # Each standard period is 55 minutes; lunch is 12:40–13:20.
    timetable = (
        ("FSDJ", 0, time(9), time(9, 55), TimetableSessionKind.LECTURE, "A-301", "Technical Training"),
        ("FSDJ", 0, time(9, 55), time(10, 50), TimetableSessionKind.LECTURE, "A-301", "Technical Training"),
        ("FSDJ", 0, time(10, 50), time(11, 45), TimetableSessionKind.LECTURE, "A-301", "Technical Training"),
        ("FSDJ", 0, time(11, 45), time(12, 40), TimetableSessionKind.LECTURE, "A-301", "Technical Training"),
        ("FSDJ", 0, time(13, 20), time(14, 15), TimetableSessionKind.LECTURE, "A-301", "Technical Training"),
        ("FSDJ", 0, time(14, 15), time(15, 10), TimetableSessionKind.LECTURE, "A-301", "Technical Training"),
        ("FSDJ", 0, time(15, 10), time(16, 5), TimetableSessionKind.LECTURE, "A-301", "Technical Training"),
        ("DL", 1, time(9), time(9, 55), TimetableSessionKind.LECTURE, "I-306", None),
        ("EWP", 1, time(9, 55), time(10, 50), TimetableSessionKind.LECTURE, "I-306", None),
        ("FOS", 1, time(10, 50), time(11, 45), TimetableSessionKind.LECTURE, "I-306", None),
        (None, 1, time(11, 45), time(12, 40), TimetableSessionKind.OTHER, "I-306", "Counselling"),
        ("PSE1", 1, time(13, 20), time(14, 15), TimetableSessionKind.LECTURE, "I-506", None),
        ("PSE1", 1, time(14, 15), time(15, 10), TimetableSessionKind.LECTURE, "I-506", None),
        ("PSE1", 1, time(15, 10), time(16, 5), TimetableSessionKind.LECTURE, "I-506", None),
        ("EWP", 2, time(9), time(9, 55), TimetableSessionKind.LECTURE, "I-306", None),
        ("QALR2", 2, time(9, 55), time(10, 50), TimetableSessionKind.LECTURE, "A-422", None),
        ("QALR2", 2, time(10, 50), time(11, 45), TimetableSessionKind.LECTURE, "A-422", None),
        ("DL", 2, time(13, 20), time(14, 15), TimetableSessionKind.LECTURE, "I-306", None),
        ("FOS", 2, time(14, 15), time(15, 10), TimetableSessionKind.LECTURE, "I-306", None),
        (None, 2, time(15, 10), time(16, 5), TimetableSessionKind.OTHER, "I-306", "Library"),
        ("EWP", 3, time(9), time(9, 55), TimetableSessionKind.LECTURE, "I-306", None),
        ("FOS", 3, time(9, 55), time(10, 50), TimetableSessionKind.LECTURE, "I-306", None),
        ("DL", 3, time(10, 50), time(11, 45), TimetableSessionKind.LECTURE, "I-306", None),
        (None, 3, time(11, 45), time(12, 40), TimetableSessionKind.OTHER, "I-306", "Open Elective-I"),
        ("DLL", 3, time(13, 20), time(14, 15), TimetableSessionKind.LAB, "I-410", "Deep Learning Lab"),
        ("DLL", 3, time(14, 15), time(15, 10), TimetableSessionKind.LAB, "I-410", "Deep Learning Lab"),
        ("DLL", 3, time(15, 10), time(16, 5), TimetableSessionKind.LAB, "I-410", "Deep Learning Lab"),
        ("FOS", 4, time(9), time(9, 55), TimetableSessionKind.LECTURE, "I-306", None),
        ("EWP", 4, time(9, 55), time(10, 50), TimetableSessionKind.LECTURE, "I-306", None),
        ("DL", 4, time(10, 50), time(11, 45), TimetableSessionKind.LECTURE, "I-306", None),
        (None, 4, time(11, 45), time(12, 40), TimetableSessionKind.OTHER, "I-306", "Open Elective-I"),
        ("EWPL", 4, time(13, 20), time(14, 15), TimetableSessionKind.LAB, "I-311", "EWP Lab"),
        ("EWPL", 4, time(14, 15), time(15, 10), TimetableSessionKind.LAB, "I-311", "EWP Lab"),
        ("EWPL", 4, time(15, 10), time(16, 5), TimetableSessionKind.LAB, "I-311", "EWP Lab"),
        (None, 5, time(9), time(9, 55), TimetableSessionKind.OTHER, None, "NSO / NSS / Outreach / Club Activities"),
        (None, 5, time(9, 55), time(10, 50), TimetableSessionKind.OTHER, None, "NSO / NSS / Outreach / Club Activities"),
        (None, 5, time(10, 50), time(11, 45), TimetableSessionKind.OTHER, None, "NSO / NSS / Outreach / Club Activities"),
        (None, 5, time(11, 45), time(12, 40), TimetableSessionKind.OTHER, None, "NSO / NSS / Outreach / Club Activities"),
        (None, 5, time(13, 20), time(14, 15), TimetableSessionKind.OTHER, None, "Sports"),
        (None, 5, time(14, 15), time(15, 10), TimetableSessionKind.OTHER, None, "Sports"),
        (None, 5, time(15, 10), time(16, 5), TimetableSessionKind.OTHER, None, "Sports"),
    )
